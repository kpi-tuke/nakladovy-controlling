...
const items = [
  ...
  },
  {
    ...
    title: 'Prehľadné grafy',
    description:
      'Získaj okamžitý vizuálny prehľad o svojich nákladoch a trendoch pomocou dynamických grafov a interaktívnych vizualizácií.',
    imageLight: `url("graphs_light.png")`,
    imageDark: `url("graphs_dark.png")`,
  },
  {
  ...
  return (
    <Container id="features" sx={{ py: { xs: 8, sm: 16 } }}>
      <Box sx={{ width: { sm: '100%', md: '60%' } }}>
        ...
        >
          Hlavné funkcie aplikácie, ktoré ti pomôžu efektívne riadiť náklady a
          optimalizovať firemné výdavky
        </Typography>
      </Box>
      <Box
        sx={{
