export const profits = [
  ...
  {value: 641, label: "641 – Tržby z predaja dlhodobého nehmotného majetku a dlhodobého hmotného majetku"},
  ...
  {value: 655, label: "655 – Zúčtovanie komplexných nákladov budúcich období"},
  {value: 657, label: "657 – Zúčtovanie oprávky k opravnej položke k nadobudnutému majetku"},
...
export const costs = [
  ...
  {value: 505, label: "505 – Tvorba a zúčtovanie opravných položiek k zásobám"},
  ...
  {value: 522, label: "522 – Príjmy spoločníkov a členov zo závislej činnosti"},
  ...
  {value: 541, label: "541 – Zostatková cena predaného dlhodobého nehmotného majetku a dlhodobého hmotného majetku"},
  ...
  {value: 547, label: "547 – Tvorba a zúčtovanie opravných položiek k pohľadávkam"},
  {value: 548, label: "548 – Ostatné náklady na hospodársku činnosť"},
  {value: 549, label: "549 – Manká a škody"},
  {value: 551, label: "551 – Odpisy dlhodobého nehmotného majetku a dlhodobého hmotného majetku"},
  {value: 553, label: "553 – Tvorba a zúčtovanie opravných položiek k dlhodobému majetku"},
  {value: 555, label: "555 – Zúčtovanie komplexných nákladov budúcich období"},
  {value: 557, label: "557 – Zúčtovanie oprávky k opravnej položke k nadobudnutému majetku\n"},
  ...
  {value: 565, label: "565 – Tvorba a zúčtovanie opravných položiek k finančnému majetku"},
  ...
  {value: 596, label: "596 – Prevod podielov na výsledku hospodárenia spoločníkom"}
]
